    ...
    <div class="container py-4">
        <div class="row gy-4 gx-5">
            <div class="col-lg-4 col-md-6">
                <h5 class="h1 text-white">Pizza Hub</h5>
                <p class="small text-muted">We offers a unique experience with its delectable toppings, delicious crusts, and variety of sauces.</p>
                <p class="small text-muted mb-0">&copy; Copyrights. All rights reserved. <a class="text-primary" href="#">Pizzahub.com</a></p>
            </div>
